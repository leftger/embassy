...
impl<'d> HCI<'d, Normal> {
    ...
    pub fn le_set_connection_cte_transmit_parameters(
        ...
        self.cmd_sender.le_set_connection_cte_transmit_parameters(handle.0, cte_types, antenna_ids)
    }
    ...
    pub fn le_connection_cte_request_enable(
        ...
        self.cmd_sender
            .le_connection_cte_request_enable(handle.0, enable, request_interval, requested_cte_length, requested_cte_type)
    }
