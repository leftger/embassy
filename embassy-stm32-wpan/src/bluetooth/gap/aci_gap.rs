...
use stm32_bindings::ble::{
    aci_gap_get_oob_data, aci_gap_set_direct_connectable, aci_gap_set_discoverable, aci_gap_set_non_discoverable,
    aci_gap_set_oob_data, aci_gap_set_undirected_connectable, aci_gap_start_scan, aci_gap_terminate_gap_proc,
    aci_gap_update_adv_data, Scan_Param_Phy_t,
};
