...
pub(crate) unsafe fn lock() {
    ...
    pac::FLASH.nscr1().modify(|w| w.set_lock(true));
}
...
pub(crate) unsafe fn disable_blocking_write() {
    ...
    #[cfg(not(feature = "trustzone-secure"))]
    pac::FLASH.nscr1().write(|w| w.set_pg(pac::flash::vals::NscrPg::B_0X0));
}
